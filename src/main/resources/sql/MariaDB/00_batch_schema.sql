...
-- Source: spring-batch-core schema-mariadb.sql
-- Use this once on environments where SPRING_BATCH_JDBC_INITIALIZE_SCHEMA=never
-- Keep all object names lowercase because Amazon Linux + MariaDB can treat
-- table names as case-sensitive and Spring Batch looks up batch_* names.
-- ============================================================
